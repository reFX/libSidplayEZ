...
{ "Antony Crowther",	{	.folder = "/MUSICIANS/C/Crowther_Antony/",			.filter = 1.1	} },
...
{ "Dane",				{	.folder = "/MUSICIANS/M/Mitch_and_Dane/Dane/",		.filter = 0.75	} },
{ "David Dunn",			{	.folder = "/MUSICIANS/D/Dunn_David/",				.filter = 0.1	} },
{ "David Whittaker",	{	.folder = "/MUSICIANS/W/Whittaker_David/",			.filter = 0.15	} },
{ "DRAX",				{	.folder = "/MUSICIANS/D/DRAX/",						.filter = 0.3	} },
{ "Edwin van Santen",	{	.folder = "/MUSICIANS/0-9/20CC/van_Santen_Edwin/",	.filter = 0.4	} },
{ "Falco Paul",			{	.folder = "/MUSICIANS/0-9/20CC/Paul_Falco/",		.filter = 0.15	} },
{ "Fegolhuzz",			{	.folder = "/MUSICIANS/F/Fegolhuzz/",				.filter = 0.25	} },
{ "Fred Gray",			{	.folder = "/MUSICIANS/G/Gray_Fred/",				.filter = 0.15	} },
{ "Future Freak",		{	.folder = "/MUSICIANS/F/Future_Freak/",				.filter = 0.35	} },
{ "Geir Tjelta",		{	.folder = "/MUSICIANS/T/Tjelta_Geir/",				.filter = 0.4	} },
{ "Georg Feil",			{	.folder = "/MUSICIANS/F/Feil_Georg/",				.filter = 0.15	} },
{ "Glenn Gallefoos",	{	.folder = "/MUSICIANS/B/Blues_Muz/Gallefoss_Glenn/",.filter = 0.15	} },
{ "Jason Page",			{	.folder = "/MUSICIANS/P/Page_Jason/",				.filter = 0.35	} },
{ "Jeroen Tel",			{	.folder = "/MUSICIANS/T/Tel_Jeroen/",				.filter = 0.35	} },
