...
{ "Barry Leitch (The Jackal)",			{	.folder = "/MUSICIANS/L/Leitch_Barry/",				.filter = 0.3,	.digi = 1.5	} },
...
{ "David Whittaker",					{	.folder = "/MUSICIANS/W/Whittaker_David/",			.filter = 0.25	} },
...
{ "Jeroen Tel",							{	.folder = "/MUSICIANS/T/Tel_Jeroen/",				.filter = 0.35,	.digi = 1.0, .exceptions = {{ "Outrun_Europa", "Jeroen Tel (Outrun Europa)" } } } },
{ "Jeroen Tel (Outrun Europa)",			{	.folder = "/MUSICIANS/T/Tel_Jeroen_2/",				.filter = 0.35,	.digi = 2.0 } },
{ "Johannes Bjerregaard",				{	.folder = "/MUSICIANS/B/Bjerregaard_Johannes/",		.filter = 0.35, .exceptions = { { "Stormlord", "Jeroen Tel"	} } } },
{ "Jonathan Dunn",						{	.folder = "/MUSICIANS/D/Dunn_Jonathan/",			.filter = 0.25,	.digi = 0.5	} },
...
{ "Mark Wilson",						{	.folder = "/MUSICIANS/W/Wilson_Mark/",				.filter = 0.2	} },
{ "Markus Müller",						{	.folder = "/MUSICIANS/M/Mueller_Markus/",			.filter = 0.5,	.zeroDac = 0.3	} },
...
{ "Michael Hendriks",					{	.folder = "/MUSICIANS/F/FAME/Hendriks_Michael/",	.filter = 0.35,	.digi = 2.2,	.zeroDac = 0.7	} },
...
{ "Paul Hannay (Feekzoid)",				{	.folder = "/MUSICIANS/F/Feekzoid/",					.digi = 0.8 } },
{ "Peter Clarke",						{	.folder = "/MUSICIANS/C/Clarke_Peter/",				.filter = 0.2	} },
{ "Pex Tufvesson",						{	.folder = "/MUSICIANS/M/Mahoney/",					.filter = 0.35	} },
{ "Ramiro Vaca",						{	.folder = "/MUSICIANS/V/Vaca_Ramiro/",				.filter = 0.7,	} },
{ "Reyn Ouwehand",						{	.folder = "/MUSICIANS/O/Ouwehand_Reyn/",			.filter = 0.8,	.digi = 0.9,	.zeroDac = 0.2	} },
{ "Richard Joseph",						{	.folder = "/MUSICIANS/J/Joseph_Richard/",			.filter = 0.3	} },
{ "Rob Hubbard",						{	.folder = "/MUSICIANS/H/Hubbard_Rob/",				.filter = 0.35,	.digi = 1.0,	.zeroDac = 0.6	} },
{ "Russell Lieblich",					{	.folder = "/MUSICIANS/L/Lieblich_Russell/",			.filter = 0.25,	.zeroDac = 0.7	} },
{ "Stellan Andersson (Dane)",			{	.folder = "/MUSICIANS/M/Mitch_and_Dane/Dane/",		.filter = 0.85,	.zeroDac = 0.3	} },
