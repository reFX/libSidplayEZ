...
{ "Dane",				{	.folder = "/MUSICIANS/M/Mitch_and_Dane/Dane/",		.filter = 0.65	} },
...
{ "Jeroen Tel",			{	.folder = "/MUSICIANS/T/Tel_Jeroen/",				.filter = 0.175	} },
...
{ "lft",				{	.folder = "/MUSICIANS/L/Lft/",						.filter = 0.1	} },
...
{ "Mitch",				{	.folder = "/MUSICIANS/M/Mitch_and_Dane/Mitch/",		.filter = 0.3	} },
...
{ "Rob Hubbard",		{	.folder = "/MUSICIANS/H/Hubbard_Rob/",				.filter = 0.3,	.exceptions = { { "BMX_Kidz", "Yip"	} } } }, 			// Only Yip used the filter for subtune 4
...
{ "Zoci-Joe",			{	.folder = "/MUSICIANS/Z/Zoci-Joe/",					.filter = -0.4	} },
