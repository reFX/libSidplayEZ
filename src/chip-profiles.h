...
{ "Chris Hülsbeck",						{	.folder = "/MUSICIANS/H/Huelsbeck_Chris/",			.filter = 0.9,	.digi = 1.1,	.zeroDac = 0.2	} },
...
{ "David Dunn",							{	.folder = "/MUSICIANS/D/Dunn_David/",				.filter = 0.15, .zeroDac = 0.7	} },
...
{ "Fred Gray",							{	.folder = "/MUSICIANS/G/Gray_Fred/",				.filter = 0.18	} },
...
{ "Glenn Gallefoos",					{	.folder = "/MUSICIANS/B/Blues_Muz/Gallefoss_Glenn/",.filter = 0.2	} },
{ "Jason Page",							{	.folder = "/MUSICIANS/P/Page_Jason/",				.filter = 0.35	} },
{ "Jeroen Tel",							{	.folder = "/MUSICIANS/T/Tel_Jeroen/",				.filter = 0.35,	.digi = 0.95	} },
{ "Johannes Bjerregaard",				{	.folder = "/MUSICIANS/B/Bjerregaard_Johannes/",		.filter = 0.35, .digi = 1.0, .exceptions = { { "Stormlord", "Jeroen Tel"	} } } },
...
{ "Mark Cooksey",						{	.folder = "/MUSICIANS/C/Cooksey_Mark/",				.filter = 0.3,	.zeroDac = 0.0	} },
...
{ "Michael Hendriks",					{	.folder = "/MUSICIANS/F/FAME/Hendriks_Michael/",	.filter = 0.35,	.digi = 1.5, .zeroDac = 0.4	} },
...
{ "Russell Lieblich",					{	.folder = "/MUSICIANS/L/Lieblich_Russell/",			.filter = 0.25,	.digi = 1.1	} },
...
{ "Jori Olkkonen (Yip)",				{	.folder = "/MUSICIANS/Y/Yip/",						.filter = 0.3,	.digi = 2.0	} },
