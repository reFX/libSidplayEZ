...
{ "Fred Gray",							{	.folder = "/MUSICIANS/G/Gray_Fred/",				.fltCox = 0.8,	.flt0Dac = 1.5	} },
{ "Geir Tjelta",						{	.folder = "/MUSICIANS/T/Tjelta_Geir/",				.fltCox = 0.5	} },
{ "Georg Feil",							{	.folder = "/MUSICIANS/F/Feil_Georg/",				.fltCox = 0.2	} },
{ "Glenn Gallefoos",					{	.folder = "/MUSICIANS/B/Blues_Muz/Gallefoss_Glenn/",.fltCox = 1.3,	.flt0Dac = 0.5,	.fltGain = 1.2	} },
...
{ "Jeroen Tel (Outrun Europa)",			{	.folder = "/MUSICIANS/T/Tel_Jeroen_2/",				.fltCox = 0.35,	.digi = 0.7 } },
{ "Johannes Bjerregaard",				{	.folder = "/MUSICIANS/B/Bjerregaard_Johannes/",		.fltCox = 0.35, .exceptions = { { "Stormlord", "Jeroen Tel"	} } } },
{ "Jonathan Dunn",						{	.folder = "/MUSICIANS/D/Dunn_Jonathan/",			.fltCox = 0.25	} },
...
{ "Rob Hubbard",						{	.folder = "/MUSICIANS/H/Hubbard_Rob/",				.fltCox = 0.35,	.flt0Dac = 0.6,	.digi = 0.9	} },
...
{ "Tim Follin",							{	.folder = "/MUSICIANS/F/Follin_Tim/",				.fltCox = 0.5	} },
